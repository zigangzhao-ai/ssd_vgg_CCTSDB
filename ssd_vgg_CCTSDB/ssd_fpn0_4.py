...
from layers import *
from data import voc, voc1, coco
...
class SSD(nn.Module):
    ...
    def forward(self, x):
        ...
        # source_final1 = sources_final[::-1]

        # for x in source_final:
        #     print(x.shape)
...
mbox = {
    ...
    '300': [6, 6, 6, 4],  # number of boxes per feature map location
    '512': [],
}
...
def build_ssd(phase, size=300, num_classes=2):
    ...
    if size != 300:
        ...
        return
    print(add_extras(extras[str(size)], 1024))
